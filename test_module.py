...
class TestCalculate(unittest.TestCase):
    ...
    def test_all_zeros(self):
        result = calculate([0, 0, 0, 0, 0, 0, 0, 0, 0])
        self.assertEqual(result['mean'][2], 0.0)
        self.assertEqual(result['variance'][2], 0.0)
        self.assertEqual(result['standard deviation'][2], 0.0)
